...
module Macros (mkDiffBench, mkGradBench, mkGradBench') where
...
mkDiffBench func = do
  ...
  [|
    bgroup
      ...
      , bench "primops/mp/double" $ nf (MPDouble.diff $func) (42.0 :: Double)
      ]
    |]
